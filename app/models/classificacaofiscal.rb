class Classificacaofiscal < AbstractRecord	 
	...
	validates :pis_aliquota, numericality: true, presence: true
	validates :cofins_cst_id, presence: true
	validates :cofins_aliquota, numericality: true, presence: true
	validates :ii_aliquota, numericality: true, presence: true
	validates :ipi_cst_id, presence: true
	validates :ipi_aliquota, numericality: true, presence: true	
